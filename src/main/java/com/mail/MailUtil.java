    ...
    public class MailUtil {  
        ...
        public static void main(String[] args) {  
            ...
            mail.setSender("778425935@163.com");  
            mail.setReceiver("778425935@163.com"); // 接收人  
            mail.setUsername("778425935@163.com"); // 登录账号,一般都是和邮箱名一样吧  
            mail.setPassword("870807"); // 发件人邮箱的登录密码  
